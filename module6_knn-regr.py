...
class KNNRegressor:
    ...
    def applyKNNAndPredit(self, inputX):
        ...
        return knn_regressor.predict([[inputX]])[0]
...
if __name__ == "__main__":
    ...
    yPredicted = knnRegressor.applyKNNAndPredit(inputX)

    print(f"Value of y predicted by kNN Regressor for input X ({inputX}): ", yPredicted)
